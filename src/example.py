...
def run_example():
	...
	try:
		...
		anf_client.volumes.pool_change(RESOURCE_GROUP_NAME,
									   anf_account.name,
									   pool_name,
									   VOLUME_NAME,
									   destination_capacity_pool.id).wait()
	...
	if CLEANUP_RESOURCES:
		...
		try:
			...
			anf_client.accounts.delete(RESOURCE_GROUP_NAME, anf_account.name).wait()
